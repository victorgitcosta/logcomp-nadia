...
class Lexer():
    ...
    def _add_tokens(self):
        ...
        self.lexer.add('SD', r'sd')
        self.lexer.add('DEMORGAN1', r'demorgan1')
        self.lexer.add('DEMORGAN2', r'demorgan2')
        self.lexer.add('DEMORGAN3', r'demorgan1')
        self.lexer.add('DEMORGAN4', r'demorgan1')
        self.lexer.add('DEMORGAN', r'demorgan')
        ...
        def program(p):
            ...
            for i in rule_info:
                ...
                # LOGCOMP
                    ...
                    rule.evaluation(self, deduction_result)
                elif isinstance(rule, DeMorganDef):
                    rule.evaluation(self, deduction_result)
...
##                      print(deduction_result.fitch)
        ...
        def DeMorgan(p):
            formula_result = p[2]
            formula = formula_result[1]
            rule = DeMorganDef(p[0].value, formula, p[4])
            self.symbol_table.insert(rule, p[0])
            self.box_latex += "{} & DeMorgan {}\\\\\n".format(formula.toLatex(), p[4].value)
            return p[0], formula_result[0]
